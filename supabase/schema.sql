...
-- ---------------------------------------------------------------------------
-- Auto-create a profile row on first sign-in (magic link only creates an
-- auth.users row; without this every join to `profiles` breaks for new
-- members).
-- ---------------------------------------------------------------------------
...
-- Admins can create/edit rooms and change a member's role.
